...
export function ResponsiveText({ value, projection, profile = "web", as: Element = "span", className = "", targetId }) {
  ...
  return (
    <Element className={className || undefined} data-xingbuild-content-target={targetId || undefined}>
